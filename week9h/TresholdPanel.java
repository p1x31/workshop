...
public class TresholdPanel extends JPanel implements Observer
{
    final private JSlider slider;
    final SpatialModel model;
    public TresholdPanel(final SpatialModel model, int min, int max, int initial)
    {
        super();
        this.model = model;
        ...
        slider.addChangeListener(new ChangeListener()
        {
            public void stateChanged(ChangeEvent e)
            {
                ...
                model.setTreshold((double)v/100.0);
            }
        }
        );
    ...
    {
        slider.setValue((int) (model.getTreshold() * 100));
    }
}
