/**
Panel containing a slider do determine the number of points in the network
*/
...
public class NumberPanel extends JPanel implements Observer
{
    ...
    public NumberPanel(final SpatialModel model, int min, int max, int initial)
    {
        ...
        slider.addChangeListener(new ChangeListener()
        {
            public void stateChanged(ChangeEvent e)
            {
                ...
                model.setNumOfPoints(v);
            }
        }
        );
        
        JLabel label = new JLabel("NumberOfNodes");
    ...
    {
        slider.setValue(model.getNumOfPoints());
    }
}
